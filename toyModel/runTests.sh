...
mkdir results_unfA_withSyst_regFirstDer_bias
mkdir results_unfB_withSyst_regFirstDer_bias
mkdir results_unfC_withSyst_regFirstDer_bias
...
./toyModel/unfoldWithSyst.py withSyst bias inputA && mv *.eps results_unfA_withSyst_regFirstDer_bias/
./toyModel/unfoldWithSyst.py withSyst bias inputB && mv *.eps results_unfB_withSyst_regFirstDer_bias/
./toyModel/unfoldWithSyst.py withSyst bias inputC && mv *.eps results_unfC_withSyst_regFirstDer_bias/
