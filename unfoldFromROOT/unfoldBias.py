...
bestTau, bestTauChi2, bestTauBias, bestTauStd = scanRegParameter(TUnfoldForRegularizationTest(f_bkg, f_mig, f_data), f_bkg, f_mig, f_eff, f_truth, 1000, np.arange(0.0, 20e-3, 0.5e-3), "scanTau_TUnfold.png", "scanTau_chi2_TUnfold.png")
